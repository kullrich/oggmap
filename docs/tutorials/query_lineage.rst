...
`oggmap` provides a command line function to download or upgrade the NCBI taxonomy database (see :ref:`commandline.ncbitax`).

How to get taxonomic information about your query species
---------------------------------------------------------

.. note::
   The oggmap submodule `qlin <https://oggmap.readthedocs.io/en/latest/modules/oggmap.html#modules-for-query-lineage>`_
   helps to get taxonomic information for you with the `qlin.get_qlin() <https://oggmap.readthedocs.io/en/latest/modules/oggmap.qlin.html#oggmap.qlin.get_qlin>`_ function.
...
Please download the notebooks from `here <https://raw.githubusercontent.com/kullrich/oggmap/main/docs/notebooks/query_lineage.ipynb>`_
